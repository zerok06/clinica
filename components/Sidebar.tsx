...
const Sidebar: React.FC<SideBarProps> = ({ data }) => {
  ...
  return (
    <SideBarContext.Provider value={{ expand, toggleExpand }}>
      <aside
        className={cn('w-[52px] transition-all duration-300', {
          'w-[170px]': !expand,
        })}
      >
        <nav className="flex-col text-white h-[calc(100svh-24px)] sticky top-3 bg-primary rounded-2xl p-2 flex">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="transition-colors duration-300 rounded-xl size-[36px] hover:bg-white/10 flex justify-center items-center"
            >
