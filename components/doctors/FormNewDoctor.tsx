...
import { createDoctors } from '@/lib/actions/doctors'
...
interface FormNewDoctorProps {
  closeAlert: () => void
}

const FormNewDoctor: React.FC<FormNewDoctorProps> = ({ closeAlert }) => {
