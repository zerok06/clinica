...
import { updateTemplateMessage } from '@/lib/actions/message'
...
interface FormUpdateMessageProps {
  closeAlert: () => void
  asunto: string
  id: string
  mensaje: string
...
const FormUpdateMessage: React.FC<FormUpdateMessageProps> = ({
  closeAlert,
  asunto,
  id,
  mensaje,
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    updateTemplateMessage(id, values).then(res =>
      toast({
